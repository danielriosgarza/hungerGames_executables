...
#mpl.rcParams.update({'font.family':'sans-serif', 'font.sans-serif':['DejaVu Sans']})
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures', '0.041_no_transition.png')
...
#to avoid warning from the colab notebook
#mpl.rcParams.update({'font.family':'sans-serif', 'font.sans-serif':['DejaVu Sans']})
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures', '0.039_no_transition.png')
plotSpecies(reactor, fileName=fileName)
...
#to avoid warning from the colab notebook
#mpl.rcParams.update({'font.family':'sans-serif', 'font.sans-serif':['DejaVu Sans']})
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures', 'pH_5.47_no_transition.png')
plotSpecies(reactor, fileName=fileName)
...
#to avoid warning from the colab notebook
#mpl.rcParams.update({'font.family':'sans-serif', 'font.sans-serif':['DejaVu Sans']})
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures', 'pH_5.50_no_transition.png')
plotSpecies(reactor, fileName=fileName)
...
#to avoid warning from the colab notebook
#mpl.rcParams.update({'font.family':'sans-serif', 'font.sans-serif':['DejaVu Sans']})
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures', 'pH_5.60_no_transition.png')
plotSpecies(reactor, fileName=fileName)
...
reactorA.microbiome.subpopD['xa'].count = 0.003
reactorA.microbiome.subpopD['xb'].count = 0.0001
reactorA.microbiome.subpopD['xe'].count = 0.003
reactorA.microbiome.subpopD['xf'].count = 0.0001
reactorA.microbiome.subpopD['xi'].count = 0.003
reactorA.microbiome.subpopD['xj'].count = 0.0001

reactorA.simulate()
#reactorA.makePlots()
t_A = reactorA.time_simul[:]*0.1
bh_A = reactorA.cellActive_dyn[0][:]
bt_A = reactorA.cellActive_dyn[1][:]
ri_A = reactorA.cellActive_dyn[2][:]
...
title = 'stateA'
fileName = os.path.join(Path(os.getcwd()).parents[1], 'files', 'Figures', 'pH_hysteresis_no_transition.png')
